...
def startTxn2_SH(value_list, cursor, connection):
    ifEqual = txn2CommProp(cursor, connection, value_list[-1], value_list[-2])
...
def txn2CommProp(cursor, connection, book_id, new_price):
...
def spin_new_server(cursor, connection, port=8090):
    options = {1: [startTxn1_FH, startTxn1_SH],
               2: [startTxn2_FH, startTxn2_SH],
               3: [startTxn3_FH],
               4: [startTxn4_FH],
               5: [startTxn5_FH, startTxn5_SH],
               6: [startTxn6_FH]}
